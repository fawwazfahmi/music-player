    ...
    <div className="flex h-full items-center justify-center px-6">
      ...
      >
        ...
        <input
          ...
          className="mt-4 w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm text-zinc-100 outline-none focus:border-sky-500"
        />
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-sky-500 px-5 py-2 text-sm font-semibold text-zinc-950 transition hover:bg-sky-400 disabled:opacity-40"
          >
            {busy ? "..." : "Create"}
          </button>
        </div>
